...
C
C---- Debug output
      CALL DBGBLVAR(ISDBG, IBLDBG, ITYP,
     &              X2, U2, T2, D2, S2, AMPL2,
     &              H2, HK2, HS2, HC2, RT2, CF2, DI2, US2, CQ2, DE2)
C
      RETURN
      END
...
C
C---- Debug output
      CALL DBGDAMPL(HK, TH, RT, AX, AX_HK, AX_TH, AX_RT)
C
      RETURN
      END ! DAMPL
...
C
C---- Debug output
      CALL DBGHKIN(H, MSQ, HK, HK_H, HK_MSQ)
C
      RETURN
      END
...
C
C---- Debug output
      CALL DBGHSL(HK, RT, MSQ, HS, HS_HK, HS_RT, HS_MSQ)
C
      RETURN
      END
...
C
C---- Debug output
      CALL DBGCFL(HK, RT, MSQ, CF, CF_HK, CF_RT, CF_MSQ)
C
      RETURN
      END
