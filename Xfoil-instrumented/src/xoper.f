...
C
C---- Debug output: dump SPECAL results
...
C---- Debug output: final viscous solution
      CALL DBGVISCFINAL(CL, CD, CM, CDP, CDF,
     &                  XOCTR(1), XOCTR(2), 0.0, 0.0, ITER, LVCONV)
C
