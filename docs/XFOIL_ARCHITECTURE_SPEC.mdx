...
## 4. Physics / Numerics Modules

### 4.1 Closure Relations
...
### 4.3 Shear Lag Equation (Turbulent)
...
### 4.4 Momentum and Shape Equations
...
## 5. Coupling Boundaries

### 5.1 Mass Defect Coupling (DIJ Matrix)
...
### 5.2 Influence Matrix Construction
...
### 5.3 Rust/Wasm Boundary (For FlexFoil)
...
## 6. Convergence and Stability Controls
