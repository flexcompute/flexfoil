...
class AirfoilSpline:
    ...
    def __init__(self, point_cloud, mesh_size,  name, is_flap=False):
        ...
        # Check if the airfoil has an open trailing edge (two distinct TE points)
        # or a closed TE (single point).
        self.open_te = False
        self.te_upper = None
        self.te_lower = None
        ...
        elif self.te_indx + 1 < len(self.points) and self.points[self.te_indx+1].x > self.te.x - tollerance:
