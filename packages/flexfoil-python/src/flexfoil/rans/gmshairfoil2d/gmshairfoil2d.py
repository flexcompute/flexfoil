...
import gmsh
from flexfoil.rans.gmshairfoil2d.airfoil_func import (four_digit_naca_airfoil, get_airfoil_points,
                                        get_all_available_airfoil_names, read_airfoil_from_file)
from flexfoil.rans.gmshairfoil2d.geometry_def import (AirfoilSpline, Circle, PlaneSurface,
                                        Rectangle, outofbounds, CType)
from flexfoil.rans.gmshairfoil2d.config_handler import read_config, merge_config_with_args, create_example_config
...
def main():
    ...
    if args.save_config:
        ...
        from flexfoil.rans.gmshairfoil2d.config_handler import write_config
