...
For cambered airfoils, there's still ~1% RMS error. Root cause analysis:

**Curvature Asymmetry Near LE:**
| Foil | cv(-0.01) | cv(+0.01) | Ratio |
|------|-----------|-----------|-------|
| NACA 0012 | 44.5 | 44.5 | 1.00 |
| NACA 2412 | 39.8 | 50.2 | 1.26 |
| NACA 4412 | 35.8 | 56.9 | 1.59 |

The lower surface has 26-59% higher curvature near the LE for cambered airfoils. This causes the Newton iteration to place slightly more panels on the lower surface, shifting the minimum-x node by 1 index.

**Panel Length Differences:**
- NACA 2412: Max 2.8% at LE region, RMS 0.046%
- NACA 4412: Max 4.1% at LE region, RMS 0.079%

**Impact on Aerodynamics:**
- Estimated Cp error: ~0.003 near LE (comparable to discretization error)
- For practical analysis, this difference is acceptable
